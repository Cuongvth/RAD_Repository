...
const Edit = () => {
  ...
  const handleAddItem = async () => {
    await edit(parseInt(selectedValue), ten, diaChi, soDienThoai);
  };
  ...
  const loadPicker = async () => {
    ...
    if (lst.length > 0) {
      setSelectedValue(lst[0].maNhaCungCap.toString());
      changePicker(lst[0].maNhaCungCap);
    }
  };
